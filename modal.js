...
const checkFirstName = () => {
	...
	if (!isRequired(userName)) {
		...
		firstName.setAttribute('data-error', 'Veuillez entrer minimum 2 charactères');
		firstName.setAttribute('data-error-visible', true);
	} else {
...
const checkLastName = () => {
	...
	if (!isRequired(userName)) {
		...
		lastName.setAttribute('data-error', 'Veuilllez entrer minimum 2 charactères');
		lastName.setAttribute('data-error-visible', true);
	} else {
...
form.addEventListener('submit', function(e) {
	...
	let isFormValid =
		isFirstNameValid && isLastNameValid && isMailValid && isConditionsValid && isLocationChosen && isNumberValid;
